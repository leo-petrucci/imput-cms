...
export interface MdastNode {
  ...
  checked?: any
  indent?: any
  attributes?: MdxNode<InputNodeTypes>['attributes']
  name?: MdxNode<InputNodeTypes>['name']
}
...
export type MdxNode<T extends InputNodeTypes> = {
  type: T['mdxJsxFlowElement']
  children: Array<DeserializedNode<T>>
  /**
  ...
  name: string
  /**
   * Component props, can be string, number array, object, etc
   */
  attributes: {
